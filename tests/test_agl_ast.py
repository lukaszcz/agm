...
class TestVisitorWalk:
    ...
    def _build_tree(self) -> Program:
        ...
        # Input decl without annotation (exercises None branch in walk)
        input_no_ann = InputDecl(name="bare", annotation=None, span=s, node_id=605)
        ...
        top_block = Block(
            items=(
                record_def, enum_def, type_alias, input_decl, input_no_ann,
    ...
    def test_walk_visits_all_decl_kinds(self) -> None:
        ...
        decl_kinds = {
            RecordDef, EnumDef, TypeAlias, InputDecl, FieldDef, VariantDef,
...
class TestUnionAliases:
    ...
    def test_declaration_union_members(self) -> None:
        import typing
        args = typing.get_args(Declaration)
        for cls in (FuncDef, RecordDef, EnumDef, TypeAlias, InputDecl, AgentDecl, ConfigPragma):
