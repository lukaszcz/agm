...
- **Assignment targets** are rebinding, container index, or record `var` field; a field assignment needs a precise record receiver, so an enum must be narrowed to its member first.
