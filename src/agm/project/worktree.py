...
from agm.project.dependency_env import update_dependency_configs_for_branch
...
def ensure_worktree(
    *,
    ...
    update_dependency_configs_for_branch(project_dir=project_dir, branch=branch_name)
