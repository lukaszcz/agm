...
class TestLetBindingScope:
    def test_simple_let_binding_identity_is_its_declaration_node(self) -> None:
    ...
    def test_let_initializer_cannot_see_its_own_name(self) -> None:
    ...
    def test_scoped_wildcard_name_creates_only_its_scope(self) -> None:
        resolved = parse_and_resolve("let A::_ = 1")
