...
The AgL reference documentation is in `docs/agl/reference/`. This reference is written from the language user perspective (audience is expert programmers familiar with CS / PL concepts). The documentation MUST NOT reference the implementation in any way - ONLY describe the AgL language.
