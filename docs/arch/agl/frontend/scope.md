...
site; qualified-pattern candidates cover every contributed route, while bare candidates remain
limited to open imports. Its diagnostics distinguish private declarations from names outside a
contribution.
