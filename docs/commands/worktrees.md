...
| Command | Description |
|---|---|
| `agm worktree new [-d\|--dir DIR] [--no-fetch] BRANCH` | Create a new branch worktree or check out an existing branch |
...
| `agm wt new [-d\|--dir DIR] [--no-fetch] BRANCH` | Alias form of `agm worktree new` |
