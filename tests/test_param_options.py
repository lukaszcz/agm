"""Tests for the param_options helper module (M4: per-param CLI options for agm exec)."""
...
class TestParamFlag:
    def test_simple_name(self) -> None:
        from agm.commands.param_options import param_flag
...
class TestCheckParamCollisions:
    def test_clean_params_no_errors(self) -> None:
        from agm.commands.param_options import check_param_collisions
...
class TestParseParamTokens:
    ...
    def test_text_value(self) -> None:
        from agm.commands.param_options import parse_param_tokens
