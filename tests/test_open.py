...
class TestResolveParentConfigBranch:
    ...
    def test_explicit_parent_branch(
        ...
        monkeypatch.setattr(
            open_module.git_helpers,
            "current_branch",
            lambda _repo_dir, **_kw: "main",
        )
        result = open_module.resolve_parent_config_branch(project_dir, "feature-a")
    ...
    def test_none_parent_returns_repo_branch_if_branch_checkout(
        ...
        result = open_module.resolve_parent_config_branch(project_dir, None)
    ...
    def test_explicit_parent_same_as_repo_branch_returns_none(
        ...
        result = open_module.resolve_parent_config_branch(project_dir, "main")
        assert result is None
    ...
    def test_explicit_parent_different_from_repo_branch(
        ...
        result = open_module.resolve_parent_config_branch(project_dir, "feature-x")
