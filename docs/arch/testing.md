...
- **Match/IR contracts.** Match-compilation and lowering suites cover the shared member-record constructor key, singleton decomposition, and descriptor-backed nominal case dispatch independently of end-to-end programs.
