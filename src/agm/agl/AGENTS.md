...
Read @docs/arch/agl.md to understand AgL implementation architecture.

**IMPORTANT**: Update docs/arch/agl.md whenever AgL implementation architecture changes – always keep this file up-to-date with the codebase.
